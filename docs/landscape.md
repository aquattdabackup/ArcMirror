...
| Tool | Documented overlap | ArcMirror's implemented local workflow |
| --- | --- | --- |
| [Blockscout Arc Explorer](https://explorer.arc.io) | Transaction, address and block inspection; the public homepage identifies itself as Arc Mainnet. | A focused explanation of each amount and conservative pairing report. Browser-level UI review remains pending. |
