...
- Owner clarified commit granularity on 2026-09-26: prefer a separate focused commit for each independent core change, test concern, UI component/route, packaging change, documentation update and evidence group. Keep each step valid and reviewable. Do not bundle several independent features into one commit, and do not manufacture empty commits or backdate work.
